...
export const Sidebar: React.FC<SidebarProps> = memo(({ activePage, setPage, onLogout, userRole }) => {
  ...
  const doctorMenuItems = [
    ...
    { id: Page.PATIENT_PROFILE, label: 'Patient Profile', arLabel: 'ملف المريض', icon: Users, color: '#14B8A6' },
    ...
    { id: Page.UNIFIED_SMART_STIMULATION, label: 'Unified Smart Stimulation', arLabel: '🔬 التنشيط المتكامل', icon: TestTube, color: '#A855F7' },
    { id: Page.SMART_STIMULATION, label: 'Stimulation Copilot', arLabel: '💉 متابعة التنشيط', icon: Sparkles, color: '#EC4899' },
